...
/************************************ emulation *********************start***************************/
    for (int i = 0; i < 15; i++)
    {
        armControlRight->setLimbADCPosition(ArmControlRight::limbAngleADCZero);
    }
...
/************************************ emulation *********************start***************************/
            int positionADC = ArmControlRight::limbAngleADCZero + round(armControlRight->getLimbPosition() * ArmControlRight::limbDegreesDiv);
            int noise = rand() % 15;
            if (noise == 0)
            {
                qDebug("NOISE ++++++++++++++++++++++++++++++++++++++++++");
