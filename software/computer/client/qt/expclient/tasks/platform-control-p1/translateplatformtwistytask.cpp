...
lwen++;
rwen++;
platformControlP1->processControlDeviceResponse(Valter::format_string("LEFT MOTOR COUNTER: %d", lwen));
platformControlP1->processControlDeviceResponse(Valter::format_string("RIGHT MOTOR COUNTER: %d", rwen));
executing = true;
