...
public slots:
    ...
    void on_head24VOnButton_clicked();
    void on_head24VOffButton_clicked();
    void on_headYawMotorEnableButton_clicked();
    void on_headYawMotorDisableButton_clicked();
    void on_headPitchMotorEnableButton_clicked();
    void on_headPitchMotorDisableButton_clicked();
    ...
    void on_powerSource5V5OnButton_clicked();
    void on_powerSource5V5OffButton_clicked();
    void on_wifiOnButton_clicked();
    void on_wifiOffButton_clicked();
    void on_leftArm24VOnButton_clicked();
    void on_leftArm24VOffButton_clicked();
    void on_rightArm24VOnButton_clicked();
    void on_rightArm24VOffButton_clicked();
    void on_headLedOnButton_clicked();
    void on_headLedOffButton_clicked();
    void on_leftAccumulatorOnButton_clicked();
    void on_leftAccumulatorOffButton_clicked();
    void on_rightAccumulatorOnButton_clicked();
    void on_rightAccumulatorOffButton_clicked();
    void on_leftArm12VOnButton_clicked();
    void on_leftArm12VOffButton_clicked();
    void on_rightArm12VOnButton_clicked();
    void on_rightArm12VOffButton_clicked();
    void on_kinect1OnButton_clicked();
    void on_kinect1OffButton_clicked();
    void on_kinect2OnButton_clicked();
    void on_kinect2OffButton_clicked();
    ...
    void on_leftForearmRollMotorOnButton_clicked();
    void on_leftForearmRollMotorOffButton_clicked();
    ...
    void on_rightForearmRollMotorOnButton_clicked();
    void on_rightForearmRollMotorOffButton_clicked();
