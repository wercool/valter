  ...
  public:
    ...
    void executeCommand(string cmd)
    {
        ...
        if (cmd.find("setCentralCommandHostInfo") != std::string::npos)
        {
            ...
            qDebug("Central Command Host IP Address:%s Port:%d", platformControlP2->getTcpInterface()->getCentralCommandHostIP().c_str(), platformControlP2->getTcpInterface()->getCentralCommandHostIPPort());
            return;
        }
