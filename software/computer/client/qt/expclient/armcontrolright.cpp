...
#include "mainclassesutils/armcontrolright.utils.cpp"
...
const int ArmControlRight::forearmAngleADCMin       = 110;
const int ArmControlRight::forearmAngleADCMax       = 900;
const int ArmControlRight::forearmAngleADCZero      = 327;
const float ArmControlRight::forearmMaxAngle        = 90; //degrees
const float ArmControlRight::forearmDegreesDiv      = (float)(ArmControlRight::forearmAngleADCMax - ArmControlRight::forearmAngleADCMin) / ArmControlRight::forearmMaxAngle;
...
const double ArmControlRight::rollStepsPerDegree = 4.5;
...
void ArmControlRight::stopAll()
{
    if (this->controlDeviceIsSet)
    {
        ...
        setRightForearmMotorActivated(false);
        setRightArmMotorActivated(false);
        setRightLimbMotorActivated(true);
