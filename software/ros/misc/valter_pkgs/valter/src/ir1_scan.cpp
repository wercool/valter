...
int main(int argc, char** argv)
{
  ...
  ros::NodeHandle n;
  ros::Publisher scan_pub = n.advertise<sensor_msgs::LaserScan>("ir1_scan", 50);
...
*/
    ...
    br.sendTransform(tf::StampedTransform(transform, ros::Time::now(), "Head", "ir_sensor1_frame"));

    //populate the LaserScan message
    sensor_msgs::LaserScan scan;
    scan.header.stamp = scan_time;
    scan.header.frame_id = "ir_sensor1_frame";
    scan.angle_min = -0.03;
    scan.angle_max = 0.03;
