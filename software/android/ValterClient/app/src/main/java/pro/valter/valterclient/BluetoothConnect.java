...
public class BluetoothConnect extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (valterClient.mConnectedThread != null) {
            valterClient.mConnectedThread.cancel();
            valterClient.mConnectedThread = null;
        }
...
//                unpairDevice(device);
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            valterClient.mConnectedThread = new ConnectedThread(mmSocket);
            valterClient.mConnectedThread.start();
            ...
            runOnUiThread(new Runnable() {
                public void run()
                {
                    Map<String, String> deviceEntry = (Map<String, String>)btDevicesList.get(selectedBTDevicesListPosition);
                    deviceEntry.put((String) deviceEntry.keySet().toArray()[0], (String)deviceEntry.values().toArray()[0] + " (connected) ");
                    btDevicesList.set(selectedBTDevicesListPosition, deviceEntry);
                    btDevicesListAdapter.notifyDataSetChanged();
                    Toast.makeText(BluetoothConnect.this, "Connected to " + mmDevice.getName(), Toast.LENGTH_SHORT).show();
                }
            });
        }
