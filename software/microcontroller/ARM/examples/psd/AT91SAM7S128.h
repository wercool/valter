/**
 * \file AT91SAM7S128.h
 * Header: CPU Register Definitions and Constants.
 * 
 * CPU Register Definitions and Constants.
 * 
*/
...
typedef struct _AT91S_SYS {
	...
	AT91_REG	 Reserved1[1]; 	//!< Reserved
	AT91_REG	 AIC_FFER; 		//!< Fast Forcing Enable Register
	AT91_REG	 AIC_FFDR; 		//!< Fast Forcing Disable Register
	AT91_REG	 AIC_FFSR; 		//!< Fast Forcing Status Register
	AT91_REG	 Reserved2[45]; //!< Reserved
	...
	AT91_REG	 Reserved3[7]; 	//!< Reserved
	AT91_REG	 DBGU_CIDR; 	//!< Chip ID Register
	AT91_REG	 DBGU_EXID; 	//!< Chip ID Extension Register
	AT91_REG	 DBGU_FNTR; 	//!< Force NTRST Register
	AT91_REG	 Reserved4[45]; //!< Reserved
	...
	AT91_REG	 Reserved5[54]; //!< Reserved
	AT91_REG	 PIOA_PER; 		//!< PIO Enable Register
	AT91_REG	 PIOA_PDR; 		//!< PIO Disable Register
	AT91_REG	 PIOA_PSR; 		//!< PIO Status Register
	AT91_REG	 Reserved6[1]; 	//!< Reserved
	AT91_REG	 PIOA_OER; 		//!< Output Enable Register
	AT91_REG	 PIOA_ODR; 		//!< Output Disable Registerr
	AT91_REG	 PIOA_OSR; 		//!< Output Status Register
	AT91_REG	 Reserved7[1]; 	//!< Reserved
	AT91_REG	 PIOA_IFER; 	//!< Input Filter Enable Register
	AT91_REG	 PIOA_IFDR; 	//!< Input Filter Disable Register
	AT91_REG	 PIOA_IFSR; 	//!< Input Filter Status Register
	AT91_REG	 Reserved8[1]; 	//!< Reserved
	...
	AT91_REG	 Reserved9[1]; 	//!< Reserved
	AT91_REG	 PIOA_PPUDR; 	//!< Pull-up Disable Register
	AT91_REG	 PIOA_PPUER; 	//!< Pull-up Enable Register
	AT91_REG	 PIOA_PPUSR; 	//!< Pull-up Status Register
	AT91_REG	 Reserved10[1]; //!< Reserved
	AT91_REG	 PIOA_ASR; 		//!< Select A Register
	AT91_REG	 PIOA_BSR; 		//!< Select B Register
	AT91_REG	 PIOA_ABSR; 	//!< AB Select Status Register
	AT91_REG	 Reserved11[9]; //!< Reserved
	AT91_REG	 PIOA_OWER; 	//!< Output Write Enable Register
	AT91_REG	 PIOA_OWDR; 	//!< Output Write Disable Register
	AT91_REG	 PIOA_OWSR; 	//!< Output Write Status Register
	AT91_REG	 Reserved12[469];	//!< Reserved
	AT91_REG	 PMC_SCER; 		//!< System Clock Enable Register
	AT91_REG	 PMC_SCDR; 		//!< System Clock Disable Register
	AT91_REG	 PMC_SCSR; 		//!< System Clock Status Register
	AT91_REG	 Reserved13[1]; //!< Reserved
	AT91_REG	 PMC_PCER; 		//!< Peripheral Clock Enable Register
	AT91_REG	 PMC_PCDR; 		//!< Peripheral Clock Disable Register
	AT91_REG	 PMC_PCSR; 		//!< Peripheral Clock Status Register
	AT91_REG	 Reserved14[1]; //!< Reserved
	AT91_REG	 PMC_MOR; 		//!< Main Oscillator Register
	AT91_REG	 PMC_MCFR; 		//!< Main Clock  Frequency Register
	AT91_REG	 Reserved15[1]; //!< Reserved
	AT91_REG	 PMC_PLLR; 		//!< PLL Register
	AT91_REG	 PMC_MCKR; 		//!< Master Clock Register
	AT91_REG	 Reserved16[3]; //!< Reserved
	AT91_REG	 PMC_PCKR[3]; 	//!< Programmable Clock Register
	AT91_REG	 Reserved17[5]; //!< Reserved
	AT91_REG	 PMC_IER; 		//!< Interrupt Enable Register
	AT91_REG	 PMC_IDR; 		//!< Interrupt Disable Register
	AT91_REG	 PMC_SR; 		//!< Status Register
	AT91_REG	 PMC_IMR; 		//!< Interrupt Mask Register
	AT91_REG	 Reserved18[36];//!< Reserved
	AT91_REG	 RSTC_RCR; 		//!< Reset Control Register
	AT91_REG	 RSTC_RSR; 		//!< Reset Status Register
	AT91_REG	 RSTC_RMR; 		//!< Reset Mode Register
	AT91_REG	 Reserved19[5]; //!< Reserved
	...
	AT91_REG	 Reserved20[5]; //!< Reserved
...
/**	@name Advanced Interrupt Controller Definitions.
*/
//@{
...
/** Peripheral DMA Controller Structure.
*/
...
/** @name Peripheral DMA Controller Definitions.
*/
//@{
...
typedef struct _AT91S_DBGU {
	...
	AT91_REG	 DBGU_THR; 		//!< Transmitter Holding Register
	AT91_REG	 DBGU_BRGR; 	//!< Baud Rate Generator Register
	AT91_REG	 Reserved0[7]; 	//!< Reserved
	AT91_REG	 DBGU_CIDR; 	//!< Chip ID Register
	AT91_REG	 DBGU_EXID; 	//!< Chip ID Extension Register
	AT91_REG	 DBGU_FNTR; 	//!< Force NTRST Register
	AT91_REG	 Reserved1[45]; //!< Reserved
	AT91_REG	 DBGU_RPR; 		//!< Receive Pointer Register
	AT91_REG	 DBGU_RCR; 		//!< Receive Counter Register
	AT91_REG	 DBGU_TPR; 		//!< Transmit Pointer Register
	AT91_REG	 DBGU_TCR; 		//!< Transmit Counter Register
...
/** Parallel Input Output Controller Structure.
*/
typedef struct _AT91S_PIO {
	AT91_REG	 PIO_PER; 		//!< PIO Enable Register
	AT91_REG	 PIO_PDR; 		//!< PIO Disable Register
	AT91_REG	 PIO_PSR; 		//!< PIO Status Register
	AT91_REG	 Reserved0[1]; 	//!< Reserved
	...
	AT91_REG	 Reserved3[1]; 	//!< Reserved
	AT91_REG	 PIO_PPUDR; 	//!< Pull-up Disable Register
	AT91_REG	 PIO_PPUER; 	//!< Pull-up Enable Register
	AT91_REG	 PIO_PPUSR; 	//!< Pull-up Status Register
	AT91_REG	 Reserved4[1]; 	//!< Reserved
	AT91_REG	 PIO_ASR; 		//!< Select A Register
	AT91_REG	 PIO_BSR; 		//!< Select B Register
	AT91_REG	 PIO_ABSR; 		//!< AB Select Status Register
	AT91_REG	 Reserved5[9]; 	//!< Reserved
...
/** Clock Generator Controller Structure.
*/
...
/** @name Clock Generator Controller Definitions.
*/ 
//@{
...
/** Power Management Controller Structure.
*/
typedef struct _AT91S_PMC {
	...
	AT91_REG	 PMC_PLLR; 		//!< PLL Register
	AT91_REG	 PMC_MCKR; 		//!< Master Clock Register
	AT91_REG	 Reserved3[3]; 	//!< Reserved
	AT91_REG	 PMC_PCKR[3]; 	//!< Programmable Clock Register
	AT91_REG	 Reserved4[5]; 	//!< Reserved
	AT91_REG	 PMC_IER; 		//!< Interrupt Enable Register
	AT91_REG	 PMC_IDR; 		//!< Interrupt Disable Register
	AT91_REG	 PMC_SR; 		//!< Status Register
	AT91_REG	 PMC_IMR; 		//!< Interrupt Mask Register
...
/** @name Power Management Controller Definitions.
*/
//@{
...
/** Reset Controller Interface Structure.
*/ 
...
/** @name Reset Controller Interface Definitions.
*/
//@{ 
...
/** Real Time Timer Controller Interface Structure.
*/
...
/** @name Real Time Timer Controller Interface Definitions.
*/
//@{
...
/** @name Periodic Interval Timer Controller Interface Definitions.
*/
//@{
...
/** Watchdog Timer Controller Interface Structure.
*/
...
/** @name Watchdog Timer Controller Interface Definitions.
*/
//@{
...
/** Voltage Regulator Mode Controller Interface Structure.
*/
typedef struct _AT91S_VREG {
	AT91_REG	 VREG_MR; 	//!< Voltage Regulator Mode Register
} AT91S_VREG, *AT91PS_VREG;

/** @name Voltage Regulator Mode Controller Interface Definitions.
*/
//@{
...
/** Serial Parallel Interface Structure
*/
typedef struct _AT91S_SPI {
	...
	AT91_REG	 Reserved0[4]; 	//!< Reserved
	AT91_REG	 SPI_CSR[4]; 	//!< Chip Select Register
	AT91_REG	 Reserved1[48]; 	//!< Reserved
...
typedef struct _AT91S_ADC {
	...
	AT91_REG	 Reserved1[44]; 	//!< Reserved
...
/** Synchronous Serial Controller Interface Structure
*/
typedef struct _AT91S_SSC {
	...
	AT91_REG	 Reserved1[2]; 	//!< Reserved
	AT91_REG	 SSC_RSHR; 	//!< Receive Sync Holding Register
	AT91_REG	 SSC_TSHR; 	//!< Transmit Sync Holding Register
	AT91_REG	 Reserved2[2]; 	//!< Reserved
	AT91_REG	 SSC_SR; 	//!< Status Register
	AT91_REG	 SSC_IER; 	//!< Interrupt Enable Register
	AT91_REG	 SSC_IDR; 	//!< Interrupt Disable Register
	AT91_REG	 SSC_IMR; 	//!< Interrupt Mask Register
	AT91_REG	 Reserved3[44]; 	//!< Reserved
...
/** @name Synchronous Serial Controller Interface
*/
//@{
...
typedef struct _AT91S_USART {
	...
	AT91_REG	 Reserved2[44]; 	//!< Reserved
...
/** Timer Counter Channel Interface Structure
*/
...
/** @name Timer Counter Channel Interface
*/
//@{
...
/** Timer Counter Interface Structure
*/
typedef struct _AT91S_TCB {
	AT91S_TC	 TCB_TC0; 	//!< TC Channel 0
	AT91_REG	 Reserved0[4]; 	//!< Reserved
	AT91S_TC	 TCB_TC1; 	//!< TC Channel 1
	AT91_REG	 Reserved1[4]; 	//!< Reserved
	AT91S_TC	 TCB_TC2; 	//!< TC Channel 2
	AT91_REG	 Reserved2[4]; 	//!< Reserved
	AT91_REG	 TCB_BCR; 	//!< TC Block Control Register
	AT91_REG	 TCB_BMR; 	//!< TC Block Mode Register
} AT91S_TCB, *AT91PS_TCB;

/** @name Timer Counter Interface Structure
*/
//@{
...
/** PWMC Channel Interface Structure
*/
...
/** Pulse Width Modulation Controller Interface Structure
*/
typedef struct _AT91S_PWMC {
	...
	AT91_REG	 Reserved0[55]; 	//!< Reserved
	AT91_REG	 PWMC_VR; 	//!< PWMC Version Register
	AT91_REG	 Reserved1[64]; 	//!< Reserved
	AT91S_PWMC_CH	 PWMC_CH[4]; 	//!< PWMC Channel
} AT91S_PWMC, *AT91PS_PWMC;

/** @name Pulse Width Modulation Controller Interface
*/
//@{
...
/** USB Device Interface Structure.
*/ 
typedef struct _AT91S_UDP {
	...
	AT91_REG	 Reserved3[4]; 	//!< Reserved
	AT91_REG	 UDP_FDR[4]; 	//!< Endpoint FIFO Data Register
	AT91_REG	 Reserved4[5]; 	//!< Reserved
	AT91_REG	 UDP_TXVC; 		//!< Transceiver Control Register
} AT91S_UDP, *AT91PS_UDP;

/** @name USB Device Interface Definitions.
*/ 
//@{
...
/** @name REGISTER ADDRESS DEFINITION FOR AT91SAM7S128
*/
//@{ 
...
/** @name PIO DEFINITIONS FOR AT91SAM7S128
*/ 
//@{
...
/** @name PERIPHERAL ID DEFINITIONS FOR AT91SAM7S128
*/ 
//@{
...
/** @name BASE ADDRESS DEFINITIONS FOR AT91SAM7S128
*/
//@{
...
/** @name MEMORY MAPPING DEFINITIONS FOR AT91SAM7S128
*/
//@{
// ISRAM
